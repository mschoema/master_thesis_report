...
% Titre
\newcommand{\titleA}{\fontTitle{Fixed-shape Regions in}} % Titre identique au titre remis au secrétariat
\newcommand{\titleB}{\fontTitle{Moving Object Databases}} % (dans la langue de rédaction a priori)
% Sous-titre
